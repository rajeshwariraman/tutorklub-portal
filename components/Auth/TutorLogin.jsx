...
export default function TutorLogin({ onLogin }) {
  ...
  const inp = { width:"100%", padding:"0.8rem", border:"1.5px solid #e0ddd6",
  ...
  return (
    <div style={{minHeight:"100vh",background:C.cream,display:"flex",
      ...
      <div style={{background:C.white,borderRadius:18,padding:"2.5rem",
        width:"100%",maxWidth:420,boxShadow:"0 4px 28px rgba(26,39,68,0.1)",textAlign:"center"}}>
        <div style={{width:48,height:48,borderRadius:12,background:C.teal,
          display:"flex",alignItems:"center",justifyContent:"center",
          fontSize:"1.4rem",margin:"0 auto 1rem"}}>✦</div>
        <h2 style={{fontFamily:"Georgia,serif",fontSize:"1.5rem",color:C.navy,marginBottom:"0.5rem"}}>
          TutorKlub Portal
        </h2>
        <div style={{background:"#e6f5f3",borderRadius:8,padding:"0.4rem 0.9rem",
          display:"inline-block",marginBottom:"0.75rem"}}>
          <span style={{fontSize:"0.75rem",fontWeight:700,color:C.teal,
            letterSpacing:"0.08em",textTransform:"uppercase"}}>🔑 Tutor Login</span>
        </div>
        <p style={{fontSize:"0.85rem",color:C.muted,marginBottom:"1.75rem"}}>
